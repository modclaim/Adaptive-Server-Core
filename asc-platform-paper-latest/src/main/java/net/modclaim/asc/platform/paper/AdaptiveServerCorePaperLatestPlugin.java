package net.modclaim.asc.platform.paper;
...
public final class AdaptiveServerCorePaperLatestPlugin extends JavaPlugin implements ASCPlugin {

    private ASCPluginController controller;

    @Override
    public void onEnable() {
        this.controller = new ASCPluginController(this, "Paper-Latest");

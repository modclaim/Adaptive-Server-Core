package net.modclaim.asc.platform.paperlegacy;
...
public final class AdaptiveServerCorePaperLegacyPlugin extends JavaPlugin implements ASCPlugin {

    private ASCPluginController controller;

    @Override
    public void onEnable() {
        this.controller = new ASCPluginController(this, "Paper-Legacy");

package net.modclaim.asc.platform.bukkit;
...
public final class AdaptiveServerCoreBukkitPlugin extends JavaPlugin implements ASCPlugin {

    private ASCPluginController controller;

    @Override
    public void onEnable() {
        this.controller = new ASCPluginController(this, "Bukkit-Baseline");
